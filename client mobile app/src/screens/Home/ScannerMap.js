  ...
  React.useEffect(() => {
    const getData = async () => {
      ...
      try {
        ...
        const url4 = `${baseURL}column/data/beatarea/${beatArea._id}`;
        console.log(url4);
      ...
      {(load || isFetching) && !userlocation ? (
        ...
        coords && (
          ...
          >
            ...
            {!destinationPoint &&
              cols.filter((i)=>mapinfo[i._id]&&mapinfo[i?._id]["danger"]>0||mapinfo[i._id]&&mapinfo[i._id]["suspect"]>0).map((user) => (
                <Marker
                  key={user._id}
                  coordinate={{
                  ...
                  pinColor= {mapinfo[user._id]["danger"]>0?'red':'orange'}
              ...
              <View>
                ...
                <View style={{ flexDirection: "row",columnGap:4 }}>
                  ...
                  <Text
                    style={{ color: "#242E42", fontWeight: 900, fontSize: 17 }}
                  >
                    suspect: {mapinfo[destinationPoint.beatloc._id]["suspect"]}
                  </Text>
                  <Text
                    style={{ color: "#242E42", fontWeight: 900, fontSize: 17 }}
                  >
                    Danger : {mapinfo[destinationPoint.beatloc._id]["danger"]}
                  </Text>
                </View>
              </View>
